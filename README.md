...
```sh
$ go get -u github.com/natu0710/xo

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/natu0710/xo
```
...
$ cp "$GOPATH/src/github.com/natu0710/xo/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/natu0710/xo/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/natu0710/xo
```
